...
/** A valid v0.3 ask, with `ma2h_version` overridden to exercise negotiation. */
function makeAsk(version: string, callback: Callback): A2hMessage {
  ...
  return { ...base, ma2h_version: version as A2hMessage["ma2h_version"] };
}
...
test("a malformed ma2h_version is a schema validation_error, not version_not_supported", () => {
