...
the originating (often ephemeral) agent via **push** (webhook) or **pull** (polling). MA2H is the
...
|-------|------|-----|-------|
| `ma2h_version` | string | MUST | `"0.2"`. Version handling per §10. |
...
```
signed_context = {
  "ma2h_version", "callback_url", "id", "in_reply_to",
