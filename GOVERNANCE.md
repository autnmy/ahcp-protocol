...
MA2H is currently **steward-governed** by Autonomy LLC. Autonomy maintains the spec, schema, and reference
...
**Stated intent:** Autonomy LLC will transfer governance of MA2H to a vendor-neutral foundation once
...
MA2H (this repository) is an **open standard**. It is distinct from **the Hub** — Autonomy LLC's hosted
server and native triage application that *implement* MA2H. The Hub is a separate, proprietary commercial
product. Nothing in MA2H requires the Hub; any conformant implementation — open-source or commercial — is a
...
4. Breaking changes bump `ma2h_version`.

## 5. Versioning

The protocol version is carried in every message as `ma2h_version`. Before 1.0 the spec is a Draft and MAY
