...
them with the reference CLI (`ma2h sign`) or `npm run vectors`.
...
```
{"callback_url":"https://deploybot.example/ma2h/resume","id":"msg_01HZXASK0001","in_reply_to":"msg_01HZXASK0001","jti":"jti_01HZX7Q9Z3DEMOFIX","ma2h_version":"0.3","payload_sha256":"3073dec57c04075d0b6bfa17c300fa9600ad92fb13e485e410c8a95274ac47ed","resolution":"answered","resolution_id":"res_01HZXR3SOLVE","resolved_at":"2026-06-04T15:48:30Z","t":"1749050910"}
```
...
```
MA2H-Signature: t=1749050910,jti=jti_01HZX7Q9Z3DEMOFIX,v1=Ryfm6kkeIKl80WEanB__dxoyL6bg5yFF33bRpu_3cxc
```
...
proxy that flips `response.value` (`hold` → `ship`) — leaving the metadata and the `MA2H-Signature` header
