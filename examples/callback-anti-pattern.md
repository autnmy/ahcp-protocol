...
**Do not do this.** MA2H v0.1's worked example pointed an `ask` callback straight at a third-party API
...
"callback": {
  ...
  "auth": { "scheme": "bearer", "token_ref": "env:MA2H_GH_DISPATCH_TOKEN" }
}
```
...
"callback": {
  "mode": "push",
  "url": "https://deploybot.example/ma2h/resume",          // agent-owned, registered, verified
  "auth": { "scheme": "hmac", "secret_ref": "env:MA2H_CALLBACK_SECRET" }
}
```
